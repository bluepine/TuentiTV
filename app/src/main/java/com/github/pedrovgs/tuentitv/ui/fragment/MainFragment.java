...
//  private static final int CONTACTS_ROW = 3;
    ...
    @Override
    public void updateBackground(String imageUrl) {
    ...
    @Override
    public void showMainInformation(List<ImageInfo> mediaElements, List<IconInfo> preferences) {
...
//        smallCarPresenter, CONTACTS_ROW);
    ...
    @Override
    public void cancelPendingBackgroundUpdates() {
